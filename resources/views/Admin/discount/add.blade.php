	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<form class="form-horizontal" role="form" action="/discount/insert" method="post" enctype="multipart/form-data">
				{!!csrf_field()!!}
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-1" placeholder="请输入优惠劵标题" class="col-xs-10 col-sm-5"  name="dis_title"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1">优惠卷金额</label>
						<div class="col-sm-9">
							<input type="text" id="form-field-2" placeholder="金额" class="col-xs-10 col-sm-2" name="dis_rule"  />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="radio" name="dis_state" value="1" />已生效
							   ...
							   <div class="widget-body">
									<div class="widget-main">
										<div>
											...
											<textarea placeholder="优惠卷详情" id="form-field-8" class="form-control" name='dis_text'></textarea>
										</div>
									</div>
								</div>
							</div>
