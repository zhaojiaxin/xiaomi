	...
	<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="/users/update" method="post" enctype="multipart/form-data">
					...
					{!!csrf_field()!!}
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1" placeholder="昵称" class="col-xs-10 col-sm-5"  name="name" value="{{$user->name}}"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email" id="form-field-1" placeholder="请输入邮箱" class="col-xs-10 col-sm-5"  name="email" value="{{$user->email}}"/>
							</div>
						</div>
