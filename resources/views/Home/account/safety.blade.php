...
<html>
	...
	<body class="zh_CN">
		...
		<script src="./Scripts/oo-min.js"></script>
		<script src="./Scripts/cookie.js"></script>
		<script src="./Scripts/time.js"></script>
		<script src="./Scripts/identity-cn.js"></script>

		<!--发短信 s-->
		<script src="./Scripts/l11n.js"></script>
		<script src="./Scripts/sms.js"></script>
		<!--发短信 e-->
		<!--密保 s-->
		<script src="./Scripts/mibao-min.js"></script>
		<!--密保 e-->
		<!--URL解析 s-->
