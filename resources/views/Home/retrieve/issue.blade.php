            ...
            <div class="wrap">
                <div class="layout">
                    <div class="n-frame device-frame reg_frame" id="main_container">
                        ...
                        <div>
                            <div class="regbox">
							<form action="/retrieve/husers" method="post" enctype="multipart/form-data">
								{!!csrf_field()!!}
                                <div class="phone_step1">
									...
									<div class="inputbg">
                                        <label class="labelbox" for="">
                                            <input name="names" data-type="PH" placeholder="请输入答案" type="tel">
                                        </label>
                                    </div>
									<div class="inputbg">
									...
									<div class="inputbg">
                                        <label class="labelbox" for="">
                                            <input name="birthdays" data-type="PH" placeholder="请输入答案" type="tel">
                                            <input name="user_id"  type="hidden" value="{{$issue->user_id}}">
									...
									<div class="inputbg">
                                        <label class="labelbox" for="">
                                            <input name="grades" data-type="PH" placeholder="请输入答案" type="tel">
                                        </label>
                                    </div>
