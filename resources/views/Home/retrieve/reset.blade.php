            ...
            <div class="wrap">
                <div class="layout">
                    <div class="n-frame device-frame reg_frame" id="main_container">
                        ...
                        <div>
                            <div class="regbox">
							<form action="/retrieve/huserd" method="post" enctype="multipart/form-data">
								{!!csrf_field()!!}
                                <div class="phone_step1">
                                    ...
                                    <div class="inputbg">
                                        ...
                                        <span style="font-size:18px" >   输入密码 : </span><p>
										   
										   <input name="password"  placeholder="请输入密码" type="password" style="position:relative;top:10px;" >
                                       
                                    </div>
									
									 <div class="inputbg">
                                       
                                         <span style="font-size:18px; position:relative;top:10px" >  请重新输入密码 :  </span><p> 
										 
										 <input name="pwd" placeholder="请重新输入密码" type="password" style="position:relative;top:20px">
                                       
										<input type="hidden" name="id" value="{{$issue->user_id}}">
                                    </div>
